...
try:
    ...
    # Aktivacija AI mozga - Pokušaj s najstabilnijom putanjom
...
# --- 4. ORIGINALNI TEKST (10 PROZORA - SVE NA HRVATSKOM) ---
prozori = [
    ...
    if upit := st.chat_input("Unesi poruku u sustav..."):
        ...
        with st.chat_message("assistant", avatar="👁️"):
            try:
                ...
                odgovor = "Veza sa simulacijom je nestabilna. G.O.D.S. odbija komunikaciju. Provjeri API ključ u postavkama."
